...
\begin{tikzfigure}
  \vspace*{-10pt}
  \hspace*{-90pt}\includegraphics[width=0.74\textwidth, height=12cm]{subcrop}
\end{tikzfigure}
\end{minipage}
}
}
...
\block{DATA RECONSTRUCTION OPTIMIZATIONS}{
...
\innerblock{}{
  ...
  \begin{tikzfigure}
    \vspace*{-20pt}
    \includegraphics[width=0.385\linewidth]{NN}\hspace{60pt}
    \includegraphics[width=0.385\linewidth]{NA}
  \end{tikzfigure}
\captionof*{table}{\boldblue{Figure:} Latent dimension response to shifts in object area and numerosity.}
}
\colorlet{innerblockbodybgcolor}{eccvgrayblue}
\innerblock{}{
\vspace*{-20pt}
\begin{tikzfigure}
  \includegraphics[width=0.385\textwidth]{bird_varied_crop}
\end{tikzfigure}
