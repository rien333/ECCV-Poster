...
\colorlet{innerblockbodybgcolor}{white}
\innerblock[bodyinnersep=25pt, bodyverticalshift=-10pt]{}{
...
\innerblock[bodyverticalshift=-10pt]{}{
  \begin{itemize}[leftmargin=*]
  \item  Numerosity and object area are represented seperately, similair to biological neuronal networks.
\end{itemize}
  \vspace*{-25pt}
}
\colorlet{innerblockbodybgcolor}{white}
...
\innerblock[bodyverticalshift=-10pt]{}{
  \begin{itemize}[leftmargin=*]
  \item Our unsupervised method performs comparably to non-machine learning algorithms trained in a supervised setting on a subitizing task.
  \end{itemize}
  \vspace*{-25pt}
}
%% \end{itemize}
...
\colorlet{innerblockbodybgcolor}{white}
\innerblock[]{}{\vspace*{-20pt}\hspace*{-28pt}\includestandalone{vae_diagram}
}
\colorlet{innerblockbodybgcolor}{eccvgrayblue}
\innerblock{}{
\boldblue{VAEs} are generative algorithms that perform \boldblue{unsupervised} representation learning. 
...
Also check out nieder2016 for figures mayeb?
the one paper (pre-Nieder) with "integral part of the visual world" maybe has figures as well
}
}
...
\innerblock[bodyinnersep=25pt]{}{
  ...
  \begin{minipage}{0.494\linewidth}
    ...
    \begin{tikzfigure}
      \vspace*{-10pt}
      \hspace*{-10pt}\includegraphics[width=0.9\linewidth]{bce_dfc_crop}
    \end{tikzfigure}
  \end{minipage}\hfill
  \begin{minipage}{0.494\linewidth}
    \centering
    ...
    \begin{tikzfigure}
      \vspace*{-10pt}
      \hspace*{15pt}\includegraphics[width=0.19\linewidth]{syn1}\hspace{3pt}%
      \includegraphics[width=0.19\linewidth]{syn2}\hspace{3pt}%
      \includegraphics[width=0.19\linewidth]{syn3}\hspace{3pt}%
      \includegraphics[width=0.19\linewidth]{syn4}\\%
      %% \bigskip
      \vspace*{3pt}
      \hspace*{15pt}\includegraphics[width=0.19\linewidth]{syn1b}\hspace{3pt}%
      \includegraphics[width=0.19\linewidth]{syn2b}\hspace{3pt}%
      \includegraphics[width=0.19\linewidth]{syn3b}\hspace{3pt}%
      \includegraphics[width=0.19\linewidth]{syn4b}%
    \end{tikzfigure}%
 \end{minipage}%
...
{Reconstruction of figure-ground organization was improved by employing \boldblue{Feature Perceptual Loss} \citep{hou2017deep} which uses intermediate layer representations from a pretrained network in the objective function of the VAE.\par}
...
\innerblock{}{
  ...
  \begin{tikzfigure}
    \vspace*{-12pt}
    \includegraphics[width=0.43\linewidth]{NN}
    \includegraphics[width=0.43\linewidth]{NA}
  \end{tikzfigure}
}
\colorlet{innerblockbodybgcolor}{eccvgrayblue}
\innerblock{}{
...
\vspace*{-20pt}
\begin{tikzfigure}
  \includegraphics[width=0.44\textwidth]{bird_varied_crop}
\end{tikzfigure}

}
\colorlet{innerblockbodybgcolor}{white}
\innerblock{}{
  Comparable with biological neuronal networks, an analysis of the learned representations revealed that numerosity is represented \boldblue{invariant to cumulative object area}. However, no latent dimension represents just one visual property. %
...
\colorlet{innerblockbodybgcolor}{eccvgrayblue}
\innerblock{}{We compare our \boldblue{unsupervised approach} to existing supervised approaches to instance counting. The strength of the representation learned by VAE is measured by training a simple \boldblue{softmax classifier} that is fed latent representations of images with corresponding count labels.} % numbers are not math font as well
}
