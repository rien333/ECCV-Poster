...
\defineblockstyle{eccv2}{
    ...
    bodyverticalshift=0pt, roundedcorners=6, linewidth=0.42cm, % same as innersep
    ...
    \begin{scope}[line width=\blocklinewidth, rounded corners=\blockroundedcorners]
      %% uncomment the ifs for different titleless look
       \ifBlockHasTitle %
           % title rectangle
           \draw[draw=none, fill=eccvgrayblue]
               (blocktitle.south west) rectangle (blocktitle.north east);
           % box outline
           \draw[color=eccvgrayblue, fill=none]
...
\defineinnerblockstyle{eccvinner}{
    titlewidthscale=1, bodywidthscale=1, titlecenter,
    titleoffsetx=0pt, titleoffsety=-00pt, bodyoffsetx=0pt, bodyoffsety=90pt,
...
\defineinnerblockstyle{eccvinnerhorizontal}{
    titlewidthscale=1, bodywidthscale=1.0, titlecenter,
    titleoffsetx=0pt, titleoffsety=-0pt, bodyoffsetx=0pt, bodyoffsety=-130pt,
    bodyverticalshift=0pt, roundedcorners=0, linewidth=0.0cm,
    titleinnersep=-50pt, bodyinnersep=25pt
}{
    \begin{scope}[line width=\innerblocklinewidth, rounded corners=\innerblockroundedcorners]
       \ifInnerblockHasTitle %
           \draw[color=innerblockbodybgcolor, fill=innerblockbodybgcolor]
               (innerblockbody.south west) rectangle (innerblocktitle.north east);
       \else
             \draw[draw=none, fill=innerblockbodybgcolor]
                 (innerblockbody.south west) rectangle (innerblockbody.north east);
...
\begin{multicols*}{2}
\innerblock{}{
\boldblue{Feature Perceptual Loss.} In our experiments we observed difficulties with reconstructing multiple salient objects, negatively affecting the ability to subitize. Therefore, we employ the recent feature perceptual loss which uses intermediate layer representations in the objective function of the autoencoder.
\begin{tikzfigure}\includegraphics[width=31cm]{bce_dfc_crop}\end{tikzfigure}
}
%% \end{minipage}
%% \begin{adjustbox}{valign=t}
%% \begin{minipage}[t]{0.51\linewidth}
\useinnerblockstyle{eccvinnerhorizontal}
\colorlet{innerblockbodybgcolor}{eccvgrayblue}
\innerblock{}{
