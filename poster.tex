...
%%   \begin{itemize}[leftmargin=*]
  \item  Numerosity and object area are represented seperately, similair to biological neural networks.
%% \end{itemize}
%%   \vspace*{-25pt}
%% }
%% \colorlet{innerblockbodybgcolor}{white}
...
%%   \begin{itemize}[leftmargin=*]
  ...
  \item Numerisoty information represented in the latent space is succesfully extrapolated to a subitizing task.
  \end{itemize}
  %% \vspace*{-25pt}
}
%% \end{itemize}
...
\colorlet{innerblockbodybgcolor}{white}
\innerblock[bodyoffsetx=-40pt]{}{\vspace*{-20pt}\hspace*{-30pt}\includestandalone{vae_diagram}
}
\colorlet{innerblockbodybgcolor}{eccvgrayblue}
\innerblock{}{
...
the one paper (pre-Nieder) with "integral part of the visual world" maybe has figures as well. Reflection of the visiospatial systems... (see paper?) How does the perceptually immediate character of subitizing arise? (visiospatial system) Lakoff voor een goede grafiek?
}
}
...
\innerblock{}{
  ...
  \begin{tikzfigure}
    ...
    \includegraphics[width=0.45\linewidth]{NA}
  \end{tikzfigure}
}
\colorlet{innerblockbodybgcolor}{eccvgrayblue}
\innerblock{}{
...
\vspace*{-20pt}
\begin{tikzfigure}
  \includegraphics[width=0.45\textwidth]{bird_varied_crop}
\end{tikzfigure}
