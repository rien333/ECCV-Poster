...
When the \boldblue{subitizing range} of 1 -- 4 is exceeded, other cogntive mechanisms are employed to arrive at an instance count. }
%% \begin{figure}%
...
\innerblock{}{Images catered to learning subitizing taken \boldblue{Salient Object Subtizing Dataset} \citep{zhang2016salient} to train our model. }
}
