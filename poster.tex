...
\begin{tikzfigure}
  \vspace*{-11pt}
  \hspace*{-90pt}\includegraphics[width=0.75\textwidth, height=12.2cm]{subcrop}
\end{tikzfigure}
\end{minipage}
}
}
...
\innerblock[bodyinnersep=25pt]{}{
  ...
  \begin{minipage}{0.494\linewidth}
    ...
    \begin{tikzfigure}
      \vspace*{-10pt}
      \hspace*{-10pt}\includegraphics[width=0.8\linewidth]{bce_dfc_crop}
    \end{tikzfigure}
  \end{minipage}\hfill
  \begin{minipage}{0.494\linewidth}
    \centering
...
\innerblock{}{
  ...
  \begin{tikzfigure}
    \vspace*{-20pt}
    \includegraphics[width=0.41\linewidth]{NN}\hspace{60pt}
    \includegraphics[width=0.41\linewidth]{NA}
  \end{tikzfigure}
\vspace*{-5pt}
% Maybe Fig.
\captionof*{table}{\boldblue{Figure.} Responses of latent dimensions to changes in object area and numerosity.}
}
\colorlet{innerblockbodybgcolor}{eccvgrayblue}
\innerblock{}{
\vspace*{-20pt}
\begin{tikzfigure}
  \includegraphics[width=0.395\textwidth]{bird_varied_crop}
\end{tikzfigure}
...
\begin{center}
  ...
  \captionof*{table}{\boldblue{Table.}  Average classification precision ({\%}) of count labels.}
\end{center}
\vspace*{-25pt}
\begin{tikzfigure}
