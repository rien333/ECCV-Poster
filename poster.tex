...
\begin{itemize}[leftmargin=*, label={\huge\raisebox{-0.25ex}{\textcolor{eccvblue}\textbullet}}]
  ...
  \item Automatic sensory apprication of exact numerosity is achieved through \boldblue{parallel processing} \citep{dehaene2011number}
  \item Nonmediated (conciously), lower neural process in the visiospatial system \cite{piazza2009humans}
  \item Emergent property of neural populations embedded in hierarchical generative models
\end{itemize}
...
%% \vspace*{-6pt}
\begin{tikzfigure}
  \includegraphics[width=0.79\textwidth]{subcrop}
\end{tikzfigure}
\end{minipage}
}
}
...
\innerblock[bodyinnersep=25pt]{}{
  ...
  \begin{minipage}{0.494\linewidth}
    ...
    \begin{tikzfigure}
      \vspace*{-10pt}
      \hspace*{-10pt}\includegraphics[width=0.85\linewidth]{bce_dfc_crop}
    \end{tikzfigure}
  \end{minipage}\hfill
  \begin{minipage}{0.494\linewidth}
    \centering
    ...
    \begin{tikzfigure}
      \vspace*{-10pt}
      \hspace*{15pt}\includegraphics[width=0.18\linewidth]{syn1}\hspace{3pt}%
      \includegraphics[width=0.18\linewidth]{syn2}\hspace{3pt}%
      \includegraphics[width=0.18\linewidth]{syn3}\hspace{3pt}%
      \includegraphics[width=0.18\linewidth]{syn4}\\%
      %% \bigskip
      \vspace*{3pt}
      \hspace*{15pt}\includegraphics[width=0.18\linewidth]{syn1b}\hspace{3pt}%
      \includegraphics[width=0.18\linewidth]{syn2b}\hspace{3pt}%
      \includegraphics[width=0.18\linewidth]{syn3b}\hspace{3pt}%
      \includegraphics[width=0.18\linewidth]{syn4b}%
    \end{tikzfigure}%
 \end{minipage}%
...
\innerblock{}{
  ...
  \begin{tikzfigure}
    \vspace*{-19pt}
    \includegraphics[width=0.405\linewidth]{NN}\hspace{50pt}
    \includegraphics[width=0.405\linewidth]{NA}
  \end{tikzfigure}
}
\colorlet{innerblockbodybgcolor}{eccvgrayblue}
\innerblock{}{
...
\vspace*{-20pt}
\begin{tikzfigure}
  \includegraphics[width=0.41\textwidth]{bird_varied_crop}
\end{tikzfigure}

}
\colorlet{innerblockbodybgcolor}{white}
\innerblock{}{
  Comparable with biological neural networks, an analysis of the learned representations revealed that numerosity is represented \boldblue{invariant to cumulative object area}. However, no latent dimension represents just one visual property. %
